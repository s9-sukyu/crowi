module.exports = function(crowi, app) {
  var trapMiddleware = require('./trap/middleware')
  ...
  var shareAccess = require('./shareAccess')(crowi, app)
  var slack = require('./slack')(crowi, app)
  var loginRequired = trapMiddleware.loginRequired
  ...
  require('./trap/disabled')(crowi, app)
  ...
  app.post('/_api/admin/settings/auth', loginRequired(crowi, app), middleware.adminRequired(), form.admin.auth, admin.api.appSetting)
  ...
  app.post('/_api/admin/settings/github', loginRequired(crowi, app), middleware.adminRequired(), csrf, form.admin.github, admin.api.appSetting)
  app.post('/_api/admin/settings/share', loginRequired(crowi, app), middleware.adminRequired(), csrf, form.admin.share, admin.api.appSetting)
  ...
  app.post('/_api/admin/users.updateEmail', loginRequired(crowi, app), middleware.adminRequired(), csrf, admin.user.updateEmail)
  ...
  app.get('/me/auth/third-party', loginRequired(crowi, app), me.authThirdParty)
  ...
  app.get('/_api/user/recentlyViewed', loginRequired(crowi, app), user.api.getRecentlyViewedPages)
  ...
  app.post('/_api/pages.renameTree', accessTokenParser, loginRequired(crowi, app), csrf, page.api.renameTree)
  app.post('/_api/pages.checkTreeRenamable', accessTokenParser, loginRequired(crowi, app), page.api.checkTreeRenamable)
  ...
  app.get('/_api/bookmarks.list', accessTokenParser, loginRequired(crowi, app), bookmark.api.list)
  ...
  app.post('/_api/shares/secretKeyword.set', accessTokenParser, loginRequired(crowi, app), csrf, share.api.setSecretKeyword)
  app.post('/_api/shares/secretKeyword.check', csrf, share.api.checkSecretKeyword)

  app.get('/_api/shares/accesses.list', accessTokenParser, loginRequired(crowi, app), shareAccess.api.list)
